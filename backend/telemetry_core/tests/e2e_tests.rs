        ...
        node_tx
            .send_json_text(json!({
                ...
                "payload": {
                    ...
                    "chain":"AXIA",
                    "config":"",
                    "genesis_hash": axia_genesis_hash(), // First party node connections aren't limited.
                    "implementation":"Axlib Node",
                    "msg":"system.connected",
                    "name": format!("Alice {}", n),
                    "network_id":"12D3KooWEyoppNCUx8Yx66oV9fJnriXwCcXwDDUA2kj6vnc6iDEp",
