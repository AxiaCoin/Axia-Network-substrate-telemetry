...
const NAME: &str = "Axlib Telemetry Backend Shard";
const ABOUT: &str = "This is the Telemetry Backend Shard that forwards the \
                     data sent by Axlib/AXIA nodes to the Backend Core";
...
struct Opts {
    ...
    ///
    /// As a reference point, syncing a new AXIA node leads to a maximum of about 25k of
