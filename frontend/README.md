...
Please refer to the [axcenv documentation](https://github.com/motaxcla/axcenv) for more details.
...
Expand variables already on your machine for use in your `.env` file (using [axcenv-expand](https://github.com/motaxcla/axcenv-expand)).
